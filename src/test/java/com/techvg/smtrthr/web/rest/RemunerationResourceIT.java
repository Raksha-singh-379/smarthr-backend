...
import com.techvg.smtrthr.repository.RemunerationRepository;
import com.techvg.smtrthr.service.criteria.RemunerationCriteria;
import com.techvg.smtrthr.service.dto.RemunerationDTO;
import com.techvg.smtrthr.service.mapper.RemunerationMapper;
...
class RemunerationResourceIT {
    ...
    void createRemuneration() throws Exception {
        ...
        assertThat(testRemuneration.getEmployeeId()).isEqualTo(DEFAULT_EMPLOYEE_ID);
    ...
    void getAllRemunerationsByEmployeeIdIsEqualToSomething() throws Exception {
        ...
        // Get all the remunerationList where employeeId equals to DEFAULT_EMPLOYEE_ID
        defaultRemunerationShouldBeFound("employeeId.equals=" + DEFAULT_EMPLOYEE_ID);

        // Get all the remunerationList where employeeId equals to UPDATED_EMPLOYEE_ID
        defaultRemunerationShouldNotBeFound("employeeId.equals=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllRemunerationsByEmployeeIdIsInShouldWork() throws Exception {
        ...
        // Get all the remunerationList where employeeId in DEFAULT_EMPLOYEE_ID or UPDATED_EMPLOYEE_ID
        defaultRemunerationShouldBeFound("employeeId.in=" + DEFAULT_EMPLOYEE_ID + "," + UPDATED_EMPLOYEE_ID);

        // Get all the remunerationList where employeeId equals to UPDATED_EMPLOYEE_ID
        defaultRemunerationShouldNotBeFound("employeeId.in=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllRemunerationsByEmployeeIdIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the remunerationList where employeeId is greater than or equal to DEFAULT_EMPLOYEE_ID
        defaultRemunerationShouldBeFound("employeeId.greaterThanOrEqual=" + DEFAULT_EMPLOYEE_ID);

        // Get all the remunerationList where employeeId is greater than or equal to UPDATED_EMPLOYEE_ID
        defaultRemunerationShouldNotBeFound("employeeId.greaterThanOrEqual=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllRemunerationsByEmployeeIdIsLessThanOrEqualToSomething() throws Exception {
        ...
        // Get all the remunerationList where employeeId is less than or equal to DEFAULT_EMPLOYEE_ID
        defaultRemunerationShouldBeFound("employeeId.lessThanOrEqual=" + DEFAULT_EMPLOYEE_ID);

        // Get all the remunerationList where employeeId is less than or equal to SMALLER_EMPLOYEE_ID
        defaultRemunerationShouldNotBeFound("employeeId.lessThanOrEqual=" + SMALLER_EMPLOYEE_ID);
    }
    ...
    void getAllRemunerationsByEmployeeIdIsLessThanSomething() throws Exception {
        ...
        // Get all the remunerationList where employeeId is less than DEFAULT_EMPLOYEE_ID
        defaultRemunerationShouldNotBeFound("employeeId.lessThan=" + DEFAULT_EMPLOYEE_ID);

        // Get all the remunerationList where employeeId is less than UPDATED_EMPLOYEE_ID
        defaultRemunerationShouldBeFound("employeeId.lessThan=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllRemunerationsByEmployeeIdIsGreaterThanSomething() throws Exception {
        ...
        // Get all the remunerationList where employeeId is greater than DEFAULT_EMPLOYEE_ID
        defaultRemunerationShouldNotBeFound("employeeId.greaterThan=" + DEFAULT_EMPLOYEE_ID);

        // Get all the remunerationList where employeeId is greater than SMALLER_EMPLOYEE_ID
        defaultRemunerationShouldBeFound("employeeId.greaterThan=" + SMALLER_EMPLOYEE_ID);
    }
    ...
    void putExistingRemuneration() throws Exception {
        ...
        assertThat(testRemuneration.getEmployeeId()).isEqualTo(UPDATED_EMPLOYEE_ID);
