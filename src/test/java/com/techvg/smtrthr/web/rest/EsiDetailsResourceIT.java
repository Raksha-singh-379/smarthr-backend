...
import com.techvg.smtrthr.repository.EsiDetailsRepository;
import com.techvg.smtrthr.service.criteria.EsiDetailsCriteria;
import com.techvg.smtrthr.service.dto.EsiDetailsDTO;
import com.techvg.smtrthr.service.mapper.EsiDetailsMapper;
...
class EsiDetailsResourceIT {
    ...
    void createEsiDetails() throws Exception {
        ...
        assertThat(testEsiDetails.getEmployeeId()).isEqualTo(DEFAULT_EMPLOYEE_ID);
    ...
    void getAllEsiDetailsByEmployeeIdIsEqualToSomething() throws Exception {
        ...
        // Get all the esiDetailsList where employeeId equals to DEFAULT_EMPLOYEE_ID
        defaultEsiDetailsShouldBeFound("employeeId.equals=" + DEFAULT_EMPLOYEE_ID);

        // Get all the esiDetailsList where employeeId equals to UPDATED_EMPLOYEE_ID
        defaultEsiDetailsShouldNotBeFound("employeeId.equals=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllEsiDetailsByEmployeeIdIsInShouldWork() throws Exception {
        ...
        // Get all the esiDetailsList where employeeId in DEFAULT_EMPLOYEE_ID or UPDATED_EMPLOYEE_ID
        defaultEsiDetailsShouldBeFound("employeeId.in=" + DEFAULT_EMPLOYEE_ID + "," + UPDATED_EMPLOYEE_ID);

        // Get all the esiDetailsList where employeeId equals to UPDATED_EMPLOYEE_ID
        defaultEsiDetailsShouldNotBeFound("employeeId.in=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllEsiDetailsByEmployeeIdIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the esiDetailsList where employeeId is greater than or equal to DEFAULT_EMPLOYEE_ID
        defaultEsiDetailsShouldBeFound("employeeId.greaterThanOrEqual=" + DEFAULT_EMPLOYEE_ID);

        // Get all the esiDetailsList where employeeId is greater than or equal to UPDATED_EMPLOYEE_ID
        defaultEsiDetailsShouldNotBeFound("employeeId.greaterThanOrEqual=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllEsiDetailsByEmployeeIdIsLessThanOrEqualToSomething() throws Exception {
        ...
        // Get all the esiDetailsList where employeeId is less than or equal to DEFAULT_EMPLOYEE_ID
        defaultEsiDetailsShouldBeFound("employeeId.lessThanOrEqual=" + DEFAULT_EMPLOYEE_ID);

        // Get all the esiDetailsList where employeeId is less than or equal to SMALLER_EMPLOYEE_ID
        defaultEsiDetailsShouldNotBeFound("employeeId.lessThanOrEqual=" + SMALLER_EMPLOYEE_ID);
    }
    ...
    void getAllEsiDetailsByEmployeeIdIsLessThanSomething() throws Exception {
        ...
        // Get all the esiDetailsList where employeeId is less than DEFAULT_EMPLOYEE_ID
        defaultEsiDetailsShouldNotBeFound("employeeId.lessThan=" + DEFAULT_EMPLOYEE_ID);

        // Get all the esiDetailsList where employeeId is less than UPDATED_EMPLOYEE_ID
        defaultEsiDetailsShouldBeFound("employeeId.lessThan=" + UPDATED_EMPLOYEE_ID);
    }
    ...
    void getAllEsiDetailsByEmployeeIdIsGreaterThanSomething() throws Exception {
        ...
        // Get all the esiDetailsList where employeeId is greater than DEFAULT_EMPLOYEE_ID
        defaultEsiDetailsShouldNotBeFound("employeeId.greaterThan=" + DEFAULT_EMPLOYEE_ID);

        // Get all the esiDetailsList where employeeId is greater than SMALLER_EMPLOYEE_ID
        defaultEsiDetailsShouldBeFound("employeeId.greaterThan=" + SMALLER_EMPLOYEE_ID);
    }
    ...
    void putExistingEsiDetails() throws Exception {
        ...
        assertThat(testEsiDetails.getEmployeeId()).isEqualTo(UPDATED_EMPLOYEE_ID);
