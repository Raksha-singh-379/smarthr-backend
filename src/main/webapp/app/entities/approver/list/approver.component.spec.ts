...
describe('Approver Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'approver', component: ApproverComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to approverService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getApproverIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getApproverIdentifier).toHaveBeenCalledWith(entity);
