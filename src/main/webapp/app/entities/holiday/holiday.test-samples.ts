...
export const sampleWithPartialData: IHoliday = {
  ...
  year: dayjs('2023-02-08T05:17'),
  lastModified: dayjs('2023-02-09T02:49'),
...
export const sampleWithFullData: IHoliday = {
  ...
  holidayDate: dayjs('2023-02-08T23:05'),
  day: 'Tools',
  year: dayjs('2023-02-09T03:21'),
  lastModified: dayjs('2023-02-08T05:15'),
