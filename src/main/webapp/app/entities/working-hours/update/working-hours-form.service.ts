...
type WorkingHoursFormGroupContent = {
  ...
  refTable: FormControl<WorkingHoursFormRawValue['refTable']>;
  refTableId: FormControl<WorkingHoursFormRawValue['refTableId']>;
};
...
export class WorkingHoursFormService {
  createWorkingHoursFormGroup(workingHours: WorkingHoursFormGroupInput = { id: null }): WorkingHoursFormGroup {
    ...
    return new FormGroup<WorkingHoursFormGroupContent>({
      ...
      refTable: new FormControl(workingHoursRawValue.refTable),
      refTableId: new FormControl(workingHoursRawValue.refTableId),
    });
  }
