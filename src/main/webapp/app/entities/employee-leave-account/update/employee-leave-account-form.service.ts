...
type EmployeeLeaveAccountFormGroupContent = {
  ...
  leaveType: FormControl<EmployeeLeaveAccountFormRawValue['leaveType']>;
  employee: FormControl<EmployeeLeaveAccountFormRawValue['employee']>;
};
...
export class EmployeeLeaveAccountFormService {
  createEmployeeLeaveAccountFormGroup(
    ...
    return new FormGroup<EmployeeLeaveAccountFormGroupContent>({
      ...
      leaveType: new FormControl(employeeLeaveAccountRawValue.leaveType),
      employee: new FormControl(employeeLeaveAccountRawValue.employee),
    });
  }
