...
type CustomLeavePolicyFormGroupContent = {
  ...
  customPolicyName: FormControl<CustomLeavePolicyFormRawValue['customPolicyName']>;
  ...
  leavePolicy: FormControl<CustomLeavePolicyFormRawValue['leavePolicy']>;
  employee: FormControl<CustomLeavePolicyFormRawValue['employee']>;
};
...
export class CustomLeavePolicyFormService {
  createCustomLeavePolicyFormGroup(customLeavePolicy: CustomLeavePolicyFormGroupInput = { id: null }): CustomLeavePolicyFormGroup {
    ...
    return new FormGroup<CustomLeavePolicyFormGroupContent>({
      ...
      customPolicyName: new FormControl(customLeavePolicyRawValue.customPolicyName),
      ...
      leavePolicy: new FormControl(customLeavePolicyRawValue.leavePolicy),
      employee: new FormControl(customLeavePolicyRawValue.employee),
    });
  }
