...
/**
 * Criteria class for the {@link com.techvg.smtrthr.domain.Department} entity. This class is used
 * in {@link com.techvg.smtrthr.web.rest.DepartmentResource} to receive all the possible filtering options from
...
public class DepartmentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, lastModified, lastModifiedBy, status, companyId, distinct);
    }
