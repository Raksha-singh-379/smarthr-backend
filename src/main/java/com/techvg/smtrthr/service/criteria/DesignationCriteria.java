...
/**
 * Criteria class for the {@link com.techvg.smtrthr.domain.Designation} entity. This class is used
 * in {@link com.techvg.smtrthr.web.rest.DesignationResource} to receive all the possible filtering options from
...
public class DesignationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, lastModified, lastModifiedBy, status, departmentId, companyId, distinct);
    }
