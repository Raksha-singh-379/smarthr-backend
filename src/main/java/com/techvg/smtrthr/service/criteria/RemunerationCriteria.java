...
/**
 * Criteria class for the {@link com.techvg.smtrthr.domain.Remuneration} entity. This class is used
 * in {@link com.techvg.smtrthr.web.rest.RemunerationResource} to receive all the possible filtering options from
...
public class RemunerationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, salaryType, amount, paymentType, employeeId, companyId, status, lastModified, lastModifiedBy, distinct);
    }
